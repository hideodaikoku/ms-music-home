  ...
  return (
    <Layout>
      <div className={join_usStyles.container}>
        ...
        <ul className={join_usStyles.caution}>
          <strong>注意</strong>
        ...
        <div className={join_usStyles.formContainer}>
          ...
          >
            ...
            <label htmlFor="email" className={join_usStyles.label}>メールアドレス<sup>*</sup></label>
            <input type="email" id="email" name="email" /><br/>

            <label htmlFor="subject" className={join_usStyles.label}>題名<sup>*</sup></label>
            <input type="text" id="subject" name="subject" />

            <label htmlFor="message">お問い合わせ内容<sup>*</sup></label>
